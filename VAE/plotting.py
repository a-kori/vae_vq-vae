...
def plot_loss_components(model_option, reconstruction_losses, sec_losses):
    '''
    ...
    # Plot the second loss component
    if model_option == 'vae':
        ax2.set_title('KL Divergence Loss')
        ax2.set_xlabel('Batch')
        ax2.set_ylabel('KL Divergence Loss')
        ax2.plot(range(len(sec_losses)), sec_losses, label='KL Divergence Loss', color='C1')
    else:
        ax2.set_title('VQ Loss')
        ax2.set_xlabel('Batch')
        ax2.set_ylabel('VQ Loss')
        ax2.plot(range(len(sec_losses)), sec_losses, label='VQ Loss', color='C1')
