...
class Encoder(nn.Module):
    def __init__(self, input_channels, latent_dim):
        ...
        self.fc1 = nn.Linear(128 * 4 * 4, 512, bias=False)
...
class Decoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.fc1 = nn.Linear(latent_dim, 512, bias=False)
        self.fc2 = nn.Linear(512, 128 * 4 * 4, bias=False)
        ...
        self.deconv3 = nn.ConvTranspose2d(32, 3, kernel_size=4, stride=2, padding=1)  # Keep bias here
